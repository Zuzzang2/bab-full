...
let RestaurantController = class RestaurantController {
    ...
    removeRestaurantFromList(req, listId, restaurantId) {
        return this.restaurantService.removeRestaurantFromList(req.user.userId, listId, restaurantId);
    }
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Delete)('/:restaurantId/list/:listId'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('listId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Param)('restaurantId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, Number]),
    __metadata("design:returntype", void 0)
], RestaurantController.prototype, "removeRestaurantFromList", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(),
    __param(0, (0, common_1.Req)()),
